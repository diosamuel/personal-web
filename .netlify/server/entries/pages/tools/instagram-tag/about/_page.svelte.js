...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  <div class="${"flex md:order-2"}"><a type="${"button"}" class="${"text-white bg-indigo-700 hover:bg-indigo-800 focus:ring-4 focus:outline-none focus:ring-indigo-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-3 md:mr-0 dark:bg-indigo-600 dark:hover:bg-indigo-700 dark:focus:ring-indigo-800"}" href="${"/tools/instagram-tag/"}">Oke udah paham</a></div></div></nav>

<div class="${"flex flex-col items-center justify-center"}"><div class="${"mt-20 m-3 border-2 border-indigo-100 p-3 lg:w-6/12 rounded-lg hover:shadow-sm"}"><img src="${"../../sedih.png"}" class="${"w-full"}"></div>
<div class="${"m-3 border-2 border-indigo-100 p-3 lg:w-6/12 rounded-lg hover:shadow-sm"}"><h1 class="${"text-1xl font-bold pb-2"}">Ini apaa?</h1>
	<p>Ini adalah website buat cari tau story instagram <s>gebetan kamu itu</s> temen kamu itu nge-tag siapa aja</p></div>
<div class="${"m-3 border-2 border-indigo-100 p-3 lg:w-6/12 rounded-lg hover:shadow-sm"}"><h1 class="${"text-1xl font-bold pb-2"}">Aman gak?</h1>
	<p>Aman, website ini gk nyimpen history kamu, privasi terjaga</p></div>
<div class="${"m-3 border-2 border-indigo-100 p-3 lg:w-6/12 rounded-lg hover:shadow-sm"}"><h1 class="${"text-1xl font-bold pb-2"}">Syaratnya?</h1>
	<p>Akun story harus publik, gk bisa akun yang privat</p></div>
<div class="${"m-3 border-2 border-indigo-100 p-3 lg:w-6/12 rounded-lg hover:shadow-sm"}"><h1 class="${"text-1xl font-bold pb-2"}">Kok tiba tiba error?</h1>
	<p>Maaf, web nya sedang dalam pengembangan, coba diulang lagi</p></div>

<div class="${"p-5"}"><p>Made with 🤩 by Virdio</p></div></div>`;
});
export {
  Page as default
};
